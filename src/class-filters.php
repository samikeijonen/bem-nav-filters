...
class Filters {
	...
	public static function init() {
		...
		add_filter( 'page_css_class', 'page_css_class', 10, 5 );
		add_filter( 'page_menu_link_attributes', 'page_menu_link_attributes', 10, 5 );
		add_filter( 'nav_menu_submenu_css_class', 'nav_menu_submenu_css_class', 10, 3 );
		add_filter( 'post_class', 'entry_classes', 10, 3 );
	}
